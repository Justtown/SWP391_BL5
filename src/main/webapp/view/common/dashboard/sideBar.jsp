            ...
            <c:if test="${sessionScope.roleName == 'manager'}">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white d-flex justify-content-between align-items-center"
                       data-bs-toggle="collapse" href="#machineSubmenu" role="button"
                       aria-expanded="false" aria-controls="machineSubmenu">
                        <span><i class="fas fa-cogs me-2"></i>Quản lý Máy móc</span>
                        <i class="fas fa-chevron-down submenu-arrow"></i>
                    </a>
                    <div class="collapse" id="machineSubmenu">
                        <ul class="nav flex-column ms-3">
                            <li class="nav-item">
                                <a class="nav-link text-white py-2" href="${ctx}/manager/machine-models">
                                    <i class="fas fa-cubes me-2"></i>Dòng máy
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white py-2" href="${ctx}/manager/machine-assets">
                                    <i class="fas fa-cog me-2"></i>Danh sách máy
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="${ctx}/manager/orders">
                        <i class="fas fa-clipboard-check me-2"></i>Duyệt đơn hàng
                    </a>
                </li>
                <li class="nav-item">
...
<style>
    ...
    #machineSubmenu .nav-link {
        font-size: 0.9rem;
        padding-left: 0.5rem;
    }

    #machineSubmenu .nav-link:hover {
