...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center">
            <div>
                <h4 class="mb-1"><i class="fas fa-clipboard-list me-2"></i>Quản lý Đơn hàng</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="content-card">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h5 class="mb-0">Danh sách đơn hàng của tôi</h5>
                    <a href="${pageContext.request.contextPath}/sale/orders?action=create" class="btn btn-primary">
                        <i class="fas fa-plus me-1"></i> Tạo đơn hàng
                    </a>
                </div>

                <!-- Filter Section -->
                <form class="filter-section" method="get" action="${pageContext.request.contextPath}/sale/orders">
                    ...
                    <div class="search-container">
                        ...
                        <input type="text" class="form-control search-input" name="keyword"
                               placeholder="Tìm theo mã đơn, tên khách hàng..." value="${keyword}">
                    </div>

                    <button type="submit" class="btn btn-outline-primary">
                        <i class="fas fa-filter me-1"></i> Lọc
                    </button>
                    <a href="${pageContext.request.contextPath}/sale/orders" class="btn btn-outline-secondary">
                                                ...
                                                <div class="action-btn-group">
                                                    ...
                                                    <c:if test="${order.status == 'PENDING'}">
                                                        ...
                                                        <button type="button" class="btn btn-danger btn-sm"
                                                                onclick="confirmCancel(${order.id}, '${order.orderCode}')" title="Hủy">
                ...
                <c:if test="${totalPages > 1}">
                    <div class="pagination-container">
                        <c:if test="${currentPage > 1}">
                            <a href="${pageContext.request.contextPath}/sale/orders?page=${currentPage - 1}&status=${statusFilter}&keyword=${keyword}"
                        ...
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <a href="${pageContext.request.contextPath}/sale/orders?page=${i}&status=${statusFilter}&keyword=${keyword}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title"><i class="fas fa-ban me-2"></i>Xác nhận hủy đơn</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <form method="post" action="${pageContext.request.contextPath}/sale/orders">
    ...
    <script>
        function viewDetail(id) {
            ...
            fetch('${pageContext.request.contextPath}/sale/orders?action=detail&id=' + id)
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (order.items && order.items.length > 0) {
                            itemsHtml = '<table class="table table-sm"><thead><tr><th>Serial</th><th>Dòng máy</th><th>Giá</th><th>Ghi chú</th></tr></thead><tbody>';
