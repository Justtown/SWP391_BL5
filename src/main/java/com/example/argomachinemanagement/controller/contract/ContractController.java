...
@WebServlet(name = "ContractController", urlPatterns = {
        "/contracts",              // generic contracts list
        "/manager/contracts",      // manager view
        "/sale/contracts",         // sale view
        "/customer/contracts"      // customer "My Contracts" view
})
